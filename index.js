...
//verify token
  function verifyJWT(req, res, next){
   ...
   const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.nk5ym.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const productCollection = client.db("car").collection("carCollection");
